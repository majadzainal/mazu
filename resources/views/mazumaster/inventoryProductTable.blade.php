            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">INVENTORY PRODUCT TABLE</h5>
                        <p class="m-b-0">&nbsp;</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Inventory Product</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script>
    ...
    function loadDataInventory(outlet_id){
        ...
        var table = $('#newTablesInventory').DataTable({
            ...
            "bFilter": true,
            "bInfo": true,
            "ajax": '/master/product-inventory/load-product',
            "aoColumns": [
    ...
    function return_value_inventory(data){
        ...
        var table = $('#logTable').DataTable({
            "ajax": '/master/product-inventory/load-log-stock/'+data.product_id,
            "scrollY": "290px",
            "scrollCollapse": true,
            "paging":  false,
            "aoColumns": [
