            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">INVENTORY OUTLET TABLE</h5>
                        <p class="m-b-0">&nbsp;</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Inventory Outlet</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script>
    ...
    function loadData(){
        ...
        var table = $('#newTables').DataTable({
            ...
            "bFilter": true,
            "bInfo": true,
            "ajax": '/master/outlet-inventory/load-outlet',
            "aoColumns": [
    ...
    function return_value(e, data){
        ...
        if (btn == "edit"){
            loadDataInventory(data.outlet_id);
        }
    ...
    function loadDataInventory(outlet_id){
        ...
        var table = $('#newTablesInventory').DataTable({
            ...
            "bFilter": true,
            "bInfo": true,
            "ajax": '/master/outlet-inventory/load/'+outlet_id,
            "aoColumns": [
                {  "mRender": function (data, type, row, num) {
                        return num.row+1;
                    }
    ...
    function return_value_inventory(data){
        var url = "";
        url += data.product_id !== null ? '/master/outlet-inventory/load-log-stock/'+ data.outlet_id+'/'+data.product_id : "";
        url += data.product_supplier_id !== null ? '/master/outlet-inventory/load-log-stock-supplier/'+ data.outlet_id+'/'+data.product_supplier_id : "";
