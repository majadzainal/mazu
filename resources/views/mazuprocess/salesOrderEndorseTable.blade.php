            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">SALES ORDER ENDORSE TABLE</h5>
                        <p class="m-b-0">&nbsp;</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Sales Order Endorse</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12" id="input">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form action="/process/sales-order-endorse/add" method="post" enctype="multipart/form-data" id="soForm">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Endorse<span class="text-danger">*</span></label>
                                            <div class="col-sm-10">
                                                <select name="endorse_id" id="endorse_id" class="js-example-placeholder col-sm-12" required>
                                                    <option value="">--Select--</option>
                                                    @foreach($endorseList as $ls)
                                                        <option value="{{ $ls->endorse_id }}">{{ $ls->endorse_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="0" name="dec_paid-form" id="dec_paid-form" oninput="calculatePaid()" class="form-control currency text-right" placeholder="Discount (%)">
                                        ...
                                        <div class="form-group row modal-footer">
                                            <div class="col-sm-12" style="text-align:right;">
                                                ...
                                                <button type="button" class="btn btn-secondary waves-effect waves-light" onClick="saveInit('#soForm', 0)">Save as draft</button>
                                                <button type="button" class="btn btn-primary waves-effect waves-light" onClick="saveInit('#soForm', 1)">Save</button>
                                            </div>
                                        </div>
                        ...
                        <div class="col-sm-12" id="payment">
                            <div class="card">
                                ...
                                <div id="payment_form">
                                    <form action="/process/sales-order-endorse-payment/add" method="post" enctype="multipart/form-data" id="paymentForm">
                                        @csrf
...
<script>
    ...
    function loadData(start_date, end_date){
        ...
        var table = $('#soTable').DataTable({
            ...
            "bFilter": true,
            "bInfo": true,
            "ajax": '/process/sales-order-endorse/load/'+start_date+'/'+end_date,
            "aoColumns": [
                ...
                },
                {
                    ...
                    "mRender": function (data, type, row) {
                        ...
                        @if(isAccess('delete', $MenuID))
                            button += "<button class='btn waves-effect waves-light btn-warning btn-icon' data-confirm='Are you sure|want to delete "+ row.so_number +"("+ row.endorse.endorse_name+") sales order??' data-url='/process/sales-order-endorse/delete/" + data + "' onClick='deleteInit(this)'>&nbsp;<i class='icofont icofont-trash'></i></button>";
                        @endif
                        return button;
                    }
                },
                ...
                {  "mRender": function (data, type, row, num) {
                        var customerStatus = "";
                        customerStatus += row.endorse.endorse_name;
    ...
    function loadProduct(){
        ...
        var table = $('#productTableList').DataTable({
            ...
            "bFilter": true,
            "bInfo": true,
            "ajax": '/process/sales-order-endorse/load-product',
            "aoColumns": [
                {  "mRender": function (data, type, row, num) {
                        return num.row+1;
                    }
    ...
    async function return_value(e, data){
        ...
        var btn = $(e).attr("btn");
        if (btn == "edit"){
            $("#soForm").attr("action", "/process/sales-order-endorse/update");
            ...
            $("#endorse_id").trigger('change');
            $("#btnCancelPO").hide();
            $("#soForm").attr("action", "/process/sales-order-endorse/add");
    ...
    async function addToReceivingTable(product_label){
        if(product_label !== ""){
            var data = await getData('/process/sales-order-endorse/get-label/'+product_label);
            if(data != null){
    ...
    function loadDataPayment(so_id){
        ...
        var table = $('#paymentTable').DataTable({
            ...
            "bFilter": true,
            "bInfo": true,
            "ajax": '/process/sales-order-endorse-payment/load/'+so_id,
            "aoColumns": [
                {  "mRender": function (data, type, row, num) {
                        return num.row+1;
                    }
