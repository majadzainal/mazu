            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">REPORT SALES ORDER TABLE</h5>
                        <p class="m-b-0">&nbsp;</p>
                    </div>
                </div>
                <div class="col-md-4">
            ...
            "buttons": [
                {
                    ...
                    title: 'Report-Sales-Order' + export_name,
                },
            ],
            "ajax": '/report/sales-order/load/'+start_date+'/'+end_date,
            "aoColumns": [
