            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">REPORT SALES ORDER OWNER TABLE</h5>
                        <p class="m-b-0">&nbsp;</p>
                    </div>
                </div>
                <div class="col-md-4">
                        ...
                        <div class="col-sm-12" id="table">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Report Sales Order Owner</h5>
                                    <span></span>
            ...
            "buttons": [
                {
                    ...
                    title: 'Report-Sales-Owner-' + export_name,
                },
            ],
            "ajax": '/report/sales-order-owner/load/'+start_date+'/'+end_date,
            "aoColumns": [
                ...
                {  "mRender": function (data, type, row, num) {
                        var customerStatus = "";
                        customerStatus += row.owner !== null ? row.owner.owner_code+" - "+row.owner.owner_name : "";
