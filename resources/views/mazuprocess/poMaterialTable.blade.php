            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">PURCHASE ORDER MATERIAL & BAHAN TABLE</h5>
                        <p class="m-b-0">&nbsp;</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Purchase Order Material & Bahan</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12" id="table">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Purchase Order Material & Bahan</h5>
                                    <span></span>
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="dt-responsive table-responsive">
                                        ...
                                        <table id="poMaterialTable" class="table table-striped table-bordered nowrap dt-responsive width-100">
                                            <thead>
                                                <tr>
                                                    <th>No.</th>
                                                    <th>Action</th>
                        ...
                        <div class="col-sm-12" id="input">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form action="/process/purchase-order-material/add" method="post" enctype="multipart/form-data" id="poMaterialForm">
                                        @csrf
                                        <input type="hidden" name="po_material_id" id="po_material_id">
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row modal-footer">
                                            <div class="col-sm-12" style="text-align:right;">
                                                ...
                                                <button type="button" class="btn btn-secondary waves-effect waves-light" onClick="saveInit('#poMaterialForm', 0)">Save as draft</button>
                                                <button type="button" class="btn btn-primary waves-effect waves-light" onClick="saveInit('#poMaterialForm', 1)">Save</button>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color:lightblue">
                <h4 class="modal-title" id="defaultModalLabel" >Select Material / Bahan</h4>
...
<script>
    ...
    function loadData(start_date, end_date){
        $('#poMaterialTable').DataTable().destroy();
        var table = $('#poMaterialTable').DataTable({
            "bPaginate": true,
            "bLengthChange": true,
            "bFilter": true,
            "bInfo": true,
            "ajax": '/process/purchase-order-material/load/'+start_date+'/'+end_date,
            "aoColumns": [
                ...
                },
                {
                    ...
                    "mRender": function (data, type, row) {
                        ...
                        @if(isAccess('delete', $MenuID))
                            button += "<button class='btn waves-effect waves-light btn-warning btn-icon' data-confirm='Are you sure|want to delete "+ row.po_number +"("+ row.supplier.supplier_name+") purchase order material??' data-url='/process/purchase-order-material/delete/" + data + "' onClick='deleteInit(this)'>&nbsp;<i class='icofont icofont-trash'></i></button>";
                        @endif
                        return button;
                    }
                },
    ...
    function loadProduct(){
        ...
        var table = $('#productTableList').DataTable({
            ...
            "bFilter": true,
            "bInfo": true,
            "ajax": '/process/purchase-order-material/load-product',
            "aoColumns": [
                {  "mRender": function (data, type, row, num) {
                        return num.row+1;
                    }
    ...
    async function return_value(e, data){
        ...
        var btn = $(e).attr("btn");
        if (btn == "edit"){
            $("#poMaterialForm").attr("action", "/process/purchase-order-material/update");
            $("#po_material_id").val(data.po_material_id);
            ...
            data.items.forEach(item => {
                addProductToPO(item.product_supplier, item);
            });
            ...
            $("#poMaterialForm").trigger("reset");
            $("#supplier_id").trigger('change');

            $("#btnCancelPO").hide();
            $("#poMaterialForm").attr("action", "/process/purchase-order-material/add");
