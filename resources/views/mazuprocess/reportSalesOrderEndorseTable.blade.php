            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">REPORT SALES ORDER ENDORSE TABLE</h5>
                        <p class="m-b-0">&nbsp;</p>
                    </div>
                </div>
                <div class="col-md-4">
                        ...
                        <div class="col-sm-12" id="table">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Report Sales Order Endorse</h5>
                                    <span></span>
...
<script>
    ...
    function loadData(start_date, end_date){
        ...
        var table = $('#soTable').DataTable({
            ...
            "ajax": '/report/sales-order-endorse/load/'+start_date+'/'+end_date,
            "aoColumns": [
                ...
                {  "mRender": function (data, type, row, num) {
                        var customerStatus = "";
                        customerStatus += row.endorse !== null ? row.endorse.endorse_code+" - "+row.endorse.endorse_name : "";
