...
<html>
  <head>
    <title>Sales Order Endorse</title>
    <style>
      ...
      <table style="width:100%;border:0">
        ...
        <tr>
            <td colspan="12" class="f_arial bottom_border" style="text-align:left;vertical-align:bottom;">
                @php
                    $email = $data->endorse->email ? $data->endorse->email : " - ";
                @endphp
                {{ $data->endorse->endorse_name." | ".$email}}
            </td>
        </tr>
        <tr>
            <td colspan="12">
        ...
        <tr>
            <td colspan="12"  class="f_arial" style="text-align:left;vertical-align:top;">
                {{ $data->endorse->endorse_name }}
            </td>
        </tr>
        <tr>
            <td colspan="8"  class="f_arial" style="text-align:left;vertical-align:top;">
                @php
                    $address = $data->endorse->address !== null ? $data->endorse->address : "-";
                @endphp
                {{ $address }}
            </td>
            <td colspan="4"></td>
