      ...
      <table style="width:100%;border:0">
        ...
        <tr>
            <td colspan="12" class="f_arial bottom_border" style="text-align:left;vertical-align:bottom;">
                @php
                    $email = $data->excReseller->email ? $data->excReseller->email : " - ";
                @endphp
                {{ $data->excReseller->reseller_name." | ".$email}}
            </td>
        </tr>
        <tr>
            <td colspan="12">
        ...
        <tr>
            <td colspan="12"  class="f_arial" style="text-align:left;vertical-align:top;">
                {{ $data->excReseller->reseller_name }}
            </td>
        </tr>
        <tr>
            <td colspan="8"  class="f_arial" style="text-align:left;vertical-align:top;">
                @php
                    $address = $data->excReseller->address !== null ? $data->excReseller->address : "-";
                @endphp
                {{ $address }}
            </td>
            <td colspan="4"></td>
