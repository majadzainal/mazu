...
<html>
  <head>
    <title>Sales Order By PO Customer</title>
    <style>
      ...
      <table style="width:100%;border:0">
        ...
        <tr>
            <td colspan="12" class="f_arial bottom_border" style="text-align:left;vertical-align:bottom;">
                @php
                    $email = $data->poCust->customer->email ? $data->poCust->customer->email : " - ";
                @endphp
                {{ $data->poCust->customer->customer_name." | ".$email}}
            </td>
        </tr>
        <tr>
            <td colspan="12">
        ...
        <tr>
            <td colspan="12"  class="f_arial" style="text-align:left;vertical-align:top;">
                {{ $data->poCust->customer->customer_name }}
            </td>
        </tr>
        <tr>
            <td colspan="8"  class="f_arial" style="text-align:left;vertical-align:top;">
                {{ $data->poCust->customer->address }}
            </td>
            <td colspan="4"></td>
        </tr>
        <tr>
