      ...
      <table style="width:100%;border:0">
        ...
        <tr>
            <td colspan="12" class="f_arial bottom_border" style="text-align:left;vertical-align:bottom;">
                @php
                    $email = $data->owner->email !== null ? $data->owner->email : " - ";
                @endphp
                {{ $data->owner->owner_name." | ".$email}}
            </td>
        </tr>
        <tr>
            <td colspan="12">
        ...
        <tr>
            <td colspan="8"  class="f_arial" style="text-align:left;vertical-align:top;">
                @php
                    $address = $data->owner->address !== null ? $data->owner->address : "-";
                @endphp
                {{ $address }}
            </td>
            <td colspan="4"></td>
