            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">REPORT SALES ORDER OUTLET TABLE</h5>
                        <p class="m-b-0">&nbsp;</p>
                    </div>
                </div>
                <div class="col-md-4">
                        ...
                        <div class="col-sm-12" id="table">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Report Sales Order Outlet</h5>
                                    <span></span>
            ...
            "buttons": [
                {
                    ...
                    title: 'Report-Sales-Outlet-' + export_name,
                },
            ],
            "ajax": '/report/sales-order-outlet/load/'+start_date+'/'+end_date,
            "aoColumns": [
                ...
                {  "mRender": function (data, type, row, num) {
                        var customerStatus = "";
                        customerStatus += row.outlet !== null ? row.outlet.outlet_code+" - "+row.outlet.outlet_name : "";
