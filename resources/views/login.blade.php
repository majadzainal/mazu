...
<!-- Mirrored from www.bootstrapdash.com/demo/login-template-free-2/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Apr 2021 05:10:42 GMT -->
<head>
  <meta charset="UTF-8">
            ...
            <div class="card-body">
              ...
              <form method="POST" action="{{ route('login') }}" id="formLogin">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="username" id="username" class="form-control mb-1" placeholder="Username">
                    @if ($error = $errors->first('username'))
                        <small class="alert btn-block alert-danger mt-0 p-1 pl-4">{{ $error }}</small>
                    @endif
                </div>
...
<!-- Mirrored from www.bootstrapdash.com/demo/login-template-free-2/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Apr 2021 05:11:22 GMT -->
</html>
