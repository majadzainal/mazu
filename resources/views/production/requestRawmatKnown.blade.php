                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form action="/production/request-raw-material/add" method="post" enctype="multipart/form-data" id="requestForm">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Process Note</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row modal-footer">
                                            ...
                                            <div class="col-sm-12" style="text-align:right;">
                                                ...
                                                <button type="button" class="save btn btn-info waves-effect waves-light" onClick="saveInit('#requestForm')">Process</button>
                                            </div>
                                        </div>
...
<script>
    ...
    function loadData(month_periode, year_periode){  
        ...
        var table = $('#newTables').DataTable({
            "ajax": '/production/request-raw-material/known-load/'+month_periode+'/'+year_periode,
            "aoColumns": [
    ...
    async function return_value(e, data){
        ...
        if (btn == "edit"){
            ...
            $("#requestForm").attr("action", "/production/request-raw-material/update-known");
