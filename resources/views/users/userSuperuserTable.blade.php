            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Users for Superuser</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<div class="modal fade" id="large-Modal" role="dialog">    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="/users-superuser/add" method="post" enctype="multipart/form-data" id="userForm">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select name="store_id" id="store_id" class="js-example-basic-single col-sm-12" required>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Super User <span class="text-danger"> *</span></label>
                        <div class="col-sm-10">
                            <div class="checkbox-color checkbox-primary">
                                <input name="is_superuser"  id="is_superuser" type="hidden">
                                <input name="is_superuserCHK" id="is_superuserCHK" type="checkbox" >
                                <label for="is_superuserCHK">
                                    <strong>Yes</strong>
                                </label>
                            </div>
                        </div>
...
<script>
                ...
                // { "data": "employee.location.location_name" },
                {
                    ...
                    "mRender": function (data, type, row) {
                        ...
                        @if(isAccess('delete', $MenuID))
                            button += "<button class='btn waves-effect waves-light btn-warning btn-icon' data-confirm='Are you sure|want to delete User "+ row.employee.employee_name +" ??' data-url='/users-superuser/delete/" + data + "' onClick='deleteInit(this)'>&nbsp;<i class='icofont icofont-trash'></i></button>";
                        @endif
                        return button;
                    }
                }
    ...
    function return_value(e, data){
        ...
        if (btn == "edit"){
            $("#userForm").attr("action", "/users-superuser/update");
            ...
            $("#is_superuserCHK").prop('checked', parseInt(data.is_superuser) > 0 ? true : false);


        } else {
            $("#userForm").trigger("reset");
            $("#userForm").attr("action", "/users-superuser/add");
