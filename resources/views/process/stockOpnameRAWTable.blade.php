            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">STOCK OPNAME RAW MATERIAL</h5>
                        <p class="m-b-0">&nbsp;</p>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-sm-12" id="table">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Stock Opname Raw Material</h5>
                                    <span></span>
                        ...
                        <div class="col-sm-12" id="input">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form action="/process/stock-opname-raw/add" method="post" enctype="multipart/form-data" id="stockopnamefgform">
                                        @csrf
                                        ...
                                        <div class="form-group" style="text-align:left;">
                                            <hr>
                                            <label class="col-sm-12 col-form-label"><h4>Raw Material</h4></label>
                                        </div>
                                        <div class="dt-responsive table-responsive">
...
<script>
    ...
    function loadData(){
        ...
        $('#searchTableOpname').DataTable({
            ...
            "bInfo": true,
            "autoWidth": false,
            "ajax": '/process/stock-opname-raw/load-opname',
            "aoColumns": [
                ...
                { "data": "created_user" },
                {
                    ...
                    "mRender": function (data, type, row) {
                        ...
                        @if(isAccess('delete', $MenuID))
                            button += "<button class='btn waves-effect waves-light btn-warning btn-icon' data-confirm='Are you sure|want to delete/cancel Stock Opname Raw Material ("+ row.stock_opname_number +")??' data-url='/process/stock-opname-raw/delete/" + data + "' onClick='deleteInit(this)'>&nbsp;<i class='icofont icofont-trash'></i></button>";
                        @endif
                        return button;
                    }
                }
    ...
    function loadDataPart(plant_id){
        ...
        export_name = "Stok Opname Raw Material "+schedule.opname_date+"-"+schedule.plant.plant_name;
        ...
        $('#searchTable1').DataTable({
            ...
            "ajax": '/process/stock-opname-raw/load/'+plant_id,
            "aoColumns": [
                { "data": "part_supplier_id" },
                { "data": "warehouse_id" },
                { "data": "unit_id" },
                {  "mRender": function (data, type, row, num) {
                ...
                { "data": "unit_name" },
                {  "mRender": function (data, type, row, num) {
                        var note = '<input type="input" name="note[]" class="form-control note"><input type="hidden" name="warehouse_id[]"  value="'+row.warehouse_id+'" class="form-control warehouse_id"> <input type="hidden" name="part_supplier_id[]"  value="'+row.part_supplier_id+'" class="form-control part_supplier_id"><input type="hidden" name="unit_id[]"  value="'+row.unit_id+'" class="form-control unit_id">';
                        return note;
                    }
                },
            ]
    ...
    function loadDataPartEdit(stokOpnameId){
        ...
        $('#searchTable1').DataTable({
            ...
            "ajax": '/process/stock-opname-raw/load-opname-item/'+stokOpnameId,
            "aoColumns": [
                { "data": "part_supplier.part_supplier_id" },
                { "data": "warehouse.warehouse_id" },
                { "data": "unit_id" },
                {  "mRender": function (data, type, row, num) {
                        var part = row.part_supplier.part_number+' - '+ row.part_supplier.part_name;
                        return part;
                    }
                },
                {  "mRender": function (data, type, row, num) {
    ...
    function return_value(e, data){
        ...
        var btn = $(e).attr("btn");
        if (btn == "edit"){
            $("#stockopnamefgform").attr("action", "/process/stock-opname-raw/update");
            ...
            $("#stockopnamefgform").attr("action", "/process/stock-opname-raw/add");
        }
    ...
    function mappingData(dataList){
        ...
        $('.stock_adjustment').each(function(i) {
            ...
            var part_id = tr.find(".part_supplier_id").val();
            var warehouse_id = parseInt(tr.find(".warehouse_id").val());
            var items = itemList.filter(a => a.part_supplier_id === part_id && a.warehouse_id === warehouse_id);
            if (items){
