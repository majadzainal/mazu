            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">STOCK OPNAME TABLE</h5>
                        <p class="m-b-0">&nbsp;</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Stock Opname Table</a></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    @if(isAccess('create', $MenuID))
                                        <button class="btn btn-primary btn-sm btn-round waves-effect waves-light" btn="add" manually="0" onClick="return_value(this)"><i class="icofont icofont-plus-circle"></i> Create Stock Opname</button>
                                    @endif
