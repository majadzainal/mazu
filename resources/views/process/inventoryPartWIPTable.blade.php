            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">INVENTORY PART WIP</h5>
                        <p class="m-b-0">&nbsp;</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Part WIP</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color:lightblue">
                <h4 class="modal-title" id="defaultModalLabel" >Part WIP</h4>
...
<script>
    ...
    function loadData(){
        ...
        var table = $('#newTables').DataTable({
            "ajax": '/process/inventory/part-wip/load',
            "rowsGroup": [1],
            "aoColumns": [
    ...
    function return_value(id){
        ...
        var table = $('#logTable').DataTable({
            "ajax": '/log/part-stock/get-data-part-customer-stock/'+ id,
            "scrollY": "290px",
            "scrollCollapse": true,
            "paging":         false,
            "aoColumns": [
    ...
    function periodeChange(){
        ...
        $('#logTable').DataTable().destroy();
            var table = $('#logTable').DataTable({
                "ajax": '/log/part-stock/get-data-part-customer-stock-periode/'+ part_id +'/'+ month +'/'+ year,
                "scrollY":        "290px",
                "scrollCollapse": true,
                "paging":         false,
                "aoColumns": [
