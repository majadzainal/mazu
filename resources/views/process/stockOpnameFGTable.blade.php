            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">STOCK OPNAME FINISHED GOODS</h5>
                        <p class="m-b-0">&nbsp;</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Finished Goods</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12" id="table">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Stock Opname Finished Goods</h5>
                                    <span></span>
                        ...
                        <div class="col-sm-12" id="input">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form action="/process/stock-opname-finished-goods/add" method="post" enctype="multipart/form-data" id="stockopnamefgform">
                                        @csrf
                                        ...
                                        <div class="form-group" style="text-align:left;">
                                            <hr>
                                            <label class="col-sm-12 col-form-label"><h4>Finished Goods</h4></label>
                                        </div>
                                        <div class="dt-responsive table-responsive">
...
<script>
    ...
    function loadData(){
        ...
        $('#searchTableOpname').DataTable({
            ...
            "bInfo": true,
            "autoWidth": false,
            "ajax": '/process/stock-opname-finished-goods/load-opname',
            "aoColumns": [
    ...
    function loadDataPart(plant_id){
        ...
        export_name = "Stok Opname Finished Goods "+schedule.opname_date+"-"+schedule.plant.plant_name;
        ...
        $('#searchTable1').DataTable({
            ...
            "ajax": '/process/stock-opname-finished-goods/load/'+plant_id,
            "aoColumns": [
    ...
    function loadDataPartEdit(stokOpnameId){
        ...
        $('#searchTable1').DataTable({
            ...
            "ajax": '/process/stock-opname-finished-goods/load-opname-item/'+stokOpnameId,
            "aoColumns": [
    ...
    function return_value(e, data){
        ...
        var btn = $(e).attr("btn");
        if (btn == "edit"){
            $("#stockopnamefgform").attr("action", "/process/stock-opname-finished-goods/update");
            ...
            $("#stockopnamefgform").attr("action", "/process/stock-opname-finished-goods/add");
        }
