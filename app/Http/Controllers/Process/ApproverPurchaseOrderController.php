...
class ApproverPurchaseOrderController extends Controller
{
    public $MenuID = '0604';
    public $objForecast;
    ...
    public function listApproverPO(){
        ...
        return view('process.approverPurchaseOrderTable', [
            'MenuID'            => $this->MenuID,
            'supplierList'      => $supplierList,
        ]);
    }

    public function loadApproverPO($month_periode, $year_periode){
        if(!isAccess('read', $this->MenuID)){
            return['data'=> ''];
        }
        ...
        $POList = PurchaseOrder::where('is_active', 1)
                                        ...
                                        ->whereIn('status_process', array(3, 4, 5, 6))
    ...
    function updateApproverPO(Request $request){
