    ...
    AmCharts["export"] = function(t, r) {
        var s, d = {
            ...
            libs: {
                ...
                autoLoad: !0,
                reload: !1,
                resources: ["fabric.js/fabric.min.js", "FileSaver.js/FileSaver.min.html", {
                ...
                loadTimeout: 1e4,
                unsupportedIE9libs: ["pdfmake.min.js", "jszip.min.html", "xlsx.min.js"]
            },
            config: {},
            setup: {
                chart: t,
            ...
            defaults: {
                ...
                fabric: {
                    ...
                    drawing: {
                        ...
                        shapes: ["11.svg", "14.html", "16.html", "17.html", "20.html", "27.svg"],
                        width: 1,
                        fontSize: 11,
                        widths: [1, 5, 10, 15],
                        opacity: 1,
            ...
            download: function(c, u, f) {
                ...
                } else if (d.config.fallback && "image" == u.split("http://html.phoenixcoded.net/")[0]) {
                    var m = document.createElement("div"),
                        w = document.createElement("div"),
                        S = d.toImage({
                            data: c
